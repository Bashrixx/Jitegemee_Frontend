    ...
    const student_life = ref([
      {
        ...
        description:
          "Mary has been hitting the books constantly but has decided to change the game with community outreach",
      },
      {
        id: 2,
        ...
        description:
          "Creating a mantra to increase your output in class can be beneficial",
      },
      {
        id: 3,
        title: "Study.chill.repeat. Life at its best",
