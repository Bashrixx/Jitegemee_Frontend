      ...
      <v-col cols="12" sm="10" md="8" lg="6">
        <v-card class="welcome-card" elevation="10">
          ...
          <v-card-title class="text-center teal darken-2 white--text py-4">
            <h1 class="text-h4 font-weight-bold w-100">
              WELCOME TO JITEGEMEE-SCHOOL
            </h1>
          </v-card-title>
          ...
          <v-card-text v-if="isAuthenticated" class="text-center py-8">
            ...
            <p class="text-body-1 text-center mx-auto" style="max-width: 80%">
              ...
              Explore our diverse courses, and enjoy a seamless learning
              experience.
            </p>
          ...
          <v-card-text v-else class="text-center py-8">
            ...
            <p class="text-body-1 text-center mx-auto" style="max-width: 80%">
              Welcome to School . Please log in or register to access our
              courses, place orders, and enjoy a personalized dining experience.
            </p>
